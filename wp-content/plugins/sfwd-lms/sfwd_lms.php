 ...
 */
define( 'LEARNDASH_VERSION', '2.5.4' );
...
if ( !defined( 'LEARNDASH_TRANSLATIONS' ) ) {
	define( 'LEARNDASH_TRANSLATIONS', false );
}
...
if ( ( defined( 'LEARNDASH_TRANSLATIONS' ) ) && ( LEARNDASH_TRANSLATIONS == true ) ) {
	...
	if ( !defined( 'LEARNDASH_TRANSLATIONS_URL_BASE' ) ) {
		//define( 'LEARNDASH_TRANSLATIONS_URL_BASE', 'http://local.ld-glotpress.com' );
		define( 'LEARNDASH_TRANSLATIONS_URL_BASE', 'http://ld-glotpress.codehooligans.com' );
	}
	if ( !defined( 'LEARNDASH_TRANSLATIONS_URL_CACHE' ) ) {
		define( 'LEARNDASH_TRANSLATIONS_URL_CACHE', DAY_IN_SECONDS );
		//define( 'LEARNDASH_TRANSLATIONS_URL_CACHE', 5 );
	}
}
