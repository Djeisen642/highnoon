...
function cf7pp_admin_after_additional_settings( $cf7 ) {
	...
	$admin_table_output .= "<td><input type='text' name='gateway' value='$gateway'> </td><td> (Required to use both Gateways at the same time. Documentation <a target='_blank' href='https://wpplugin.org/documentation/paypal-stripe-gateway-code/'>here</a>)</td></tr><tr><td colspan='3'><br />";
