...
<form method='post'>
	...
	<div id="6" style="display:none;border: 1px solid #CCCCCC;<?php echo $active_tab == '6' ? 'display:block;' : ''; ?>">
		...
		<div style="background-color:#fff;padding:8px;">
			...
			<table style="width: 100%;">
				...
				<tr><td class='cf7pp_width'><b>Cancel URL: </b></td><td><input type='text' name='cancel' value='<?php echo $options['cancel']; ?>'> Optional <br /></td></tr>
				<tr><td class='cf7pp_width'></td><td>If the customer goes to PayPal and clicks the cancel button, where do they go. Example: <?php echo $siteurl; ?>/cancel. Max length: 1,024. </td></tr>

				<tr><td>
				<br />
				</td></tr>

				<tr><td class='cf7pp_width'><b>Return URL: </b></td><td><input type='text' name='return' value='<?php echo $options['return']; ?>'> Optional <br /></td></tr>
				<tr><td class='cf7pp_width'></td><td>If the customer goes to PayPal and successfully pays, where are they redirected to after. Example: <?php echo $siteurl; ?>/thankyou. Max length: 1,024. </td></tr>
	...
	<div style="border: 1px solid #CCCCCC;">	
		...
		<center><label style="font-size:14pt;">Pro Features: </label></center>
		
		<br />
		<div class="dashicons dashicons-yes" style="margin-bottom: 6px;"></div> Only send email if payment is successful. <br />
		<div class="dashicons dashicons-yes" style="margin-bottom: 6px;"></div> Link form items to price <br />
		<div class="dashicons dashicons-yes" style="margin-bottom: 6px;"></div> Link form items to quantity <br />
		<div class="dashicons dashicons-yes" style="margin-bottom: 6px;"></div> Link form items to description <br />
		...
		<div class="dashicons dashicons-yes" style="margin-bottom: 6px;"></div> Skip redirect<br />
