	...
	<table class="form-table">
		...
		<tr valign="top" class="options-header-container">
			<th scope="row" colspan="2">
				<h2><?php _e( 'Existing Users', 'uncanny-learndash-group-management' ); ?></h2>
			</th>
		</tr>

		<tr valign="top" class="option-setting-container">
			<th scope="row">
				<h4><?php _e( 'For imported existing users, ', 'uncanny-learndash-group-management' ); ?></h4></th>
			<td>
				<label>
		...
		<tr valign="top" class="options-header-container">
			<th scope="row" colspan="2">
				<h2><?php _e( 'User Roles', 'uncanny-learndash-group-management' ); ?></h2>
			</th>
		</tr>

		<tr valign="top" class="option-setting-container">
			<th scope="row">
				<h4><?php _e( 'Set the Role for imported users', 'uncanny-learndash-group-management' ); ?></h4>
		...
		<tr valign="top" class="options-header-container">
			<th scope="row" colspan="2">
				<h2><?php _e( 'Courses', 'uncanny-learndash-group-management' ); ?></h2>
			</th>
		</tr>

		<tr valign="top" class="option-setting-container">
			<th scope="row">
				<h4><?php _e( 'Enroll users in course(s)', 'uncanny-learndash-group-management' ); ?></h4>
				<ul class="import-user-list">
			...
			<td class="listed-label-input">
				...
				<?php else : ?>
					<p><?php _e( 'No Courses Published' ); ?></p>
				<?php endif; ?>
			</td>
		</tr>
		...
		<tr valign="top" class="options-header-container">
			<th scope="row" colspan="2">
				<h2><?php _e( 'Groups', 'uncanny-learndash-group-management' ); ?></h2>
			</th>
		</tr>

		<tr valign="top" class="option-setting-container">
			<th scope="row">
				<h4><?php _e( 'Add users to group(s)', 'uncanny-learndash-group-management' ); ?></h4>
				<ul class="import-user-list">
			...
			<td class="listed-label-input">
				...
				<?php else : ?>
					<p><?php _e( 'No Groups Published' ); ?></p>
				<?php endif; ?>
			</td>
		</tr>
