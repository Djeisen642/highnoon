	...
	<table class="form-table">
		...
		<tr valign="top" class="options-header-container">
			<th scope="row" colspan="2">
				<h2><?php _e( 'New User Email Template', 'uncanny-learndash-group-management' ); ?></h2>
			</th>
		</tr>

		<tr valign="top" class="option-setting-container">
			<th scope="row"><h4><?php _e( 'Email to New Users', 'uncanny-learndash-group-management' ); ?></h4></th>
			<td>
				<label>
		...
		<tr valign="top" class="option-setting-container">
			<th scope="row"><h4><?php _e( 'Subject', 'uncanny-learndash-group-management' ); ?></h4></th>
			<td>
		...
		<tr valign="top">
			...
			<th scope="row">
				<h4><?php _e( 'Body', 'uncanny-learndash-group-management' ); ?></h4>
				<h5><?php _e( 'Variables', 'uncanny-learndash-group-management' ); ?></h5>
		...
		<tr valign="top" class="option-setting-container">
			<th scope="row"><h4><?php _e( 'Test Email Address: ', 'uncanny-learndash-group-management' ); ?></h4></th>
			<td>
				<label>
		...
		<tr valign="top" class="options-header-container">
			<th colspan="2">
				<h2><?php _e( 'Updated User Email Template', 'uncanny-learndash-group-management' ); ?></h2>
			</th>
		</tr>

		<tr valign="top" class="option-setting-container">
			<th scope="row"><h4><?php _e( 'Email to Updated Users', 'uncanny-learndash-group-management' ); ?></h4></th>
			<td>
				<label>
