...
$csv_sample_file_link = plugins_url( basename( dirname( UO_FILE ) ) ) . '\src\assets\backend\csv\import_user_sample.csv';
...
<div id="import-users-upload">
	...
	<h2 class="options-header-container">Import LearnDash Users</h2>
...
<div id="import-users-progress">
	...
	<div class="import-progress-bar">
		<img src="/wp-includes/js/thickbox/loadingAnimation.gif"
		     data-lazy-src="/wp-includes/js/thickbox/loadingAnimation.gif" class="lazyloaded" scale="0">
