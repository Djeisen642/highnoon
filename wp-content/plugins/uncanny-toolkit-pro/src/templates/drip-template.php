...
$drip_course = new \uncanny_pro_toolkit\UncannyDripLessonsByGroup();
		...
		<div id="learndash_course_content" class="learndash_course_content">
			...
			<?php if ( ! empty( $lessons ) ) : ?>
				...
				<div class="expand_collapse">
					<a href="#" onClick='jQuery("#learndash_post_<?php echo $course_id; ?> .learndash_topic_dots").slideDown(); return false;'><?php _e( 'Expand All', 'learndash' ); ?></a>
					|
					<a href="#" onClick='jQuery("#learndash_post_<?php echo esc_attr( $course_id ); ?> .learndash_topic_dots").slideUp(); return false;'><?php _e( 'Collapse All', 'learndash' ); ?></a>
				</div>
