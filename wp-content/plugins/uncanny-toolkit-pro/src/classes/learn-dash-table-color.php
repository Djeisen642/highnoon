...
class LearnDashTableColor extends toolkit\Config implements toolkit\RequiredFunctions {
	...
	public static function get_details() {
		...
		$class_title = esc_html__( 'LearnDash Table Colors', 'uncanny-pro-toolkit' );

		$kb_link = 'http://www.uncannyowl.com/knowledge-base/learndash-table-colors/';

		/* Sample Simple Description with shortcode */
		$class_description = esc_html__( 'Change the background and header text color of LearnDash tables. This module modifies the course, lesson, topic, quiz, and Pro Dashboard tables.', 'uncanny-pro-toolkit' );
