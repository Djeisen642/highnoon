<?php
  ...
  if ($post->post_type == 'sfwd-lessons' || $post->post_type == 'sfwd-topic' || $post->post_type == 'sfwd-courses' || $post->post_type == 'campaigns') {
	...
	$image = get_option('stack_blog_breadcrumb_image', '');
?>
...
<section class="unpad text-center ">
    <div class="row--gapless">
	            ...
	            <a href="<?php echo esc_url( get_permalink( $prev_post->ID ) ); ?>" class="block">
	                <div class="feature feature-7 boxed imagebg" data-overlay="5">
	                    ...
	                    <h4 class="pos-vertical-center">
	                    	<span><?php esc_html_e( 'Previous Post', 'stack' ); ?></span>
        ...
        <div class="col-sm-4 col-xs-12">
            <a href="<?php echo get_post_type_archive_link( 'post' ); ?>" class="block">
                <div class="feature feature-7 boxed imagebg" data-overlay="5">
                    <div class="background-image-holder">
                        <?php
                        	if( $image ){
                    ...
                    <h4 class="pos-vertical-center">
                    	<span><?php echo get_option('stack_blog_title', 'Our Blog'); ?></span>
                    	<?php echo get_option('stack_blog_description', ''); ?>
                    </h4>
                </div>
            </a>
        </div>
	        ...
	        <div class="col-sm-4 col-xs-12">
	            <a href="<?php echo esc_url( get_permalink( $next_post->ID ) ); ?>" class="block">
	                <div class="feature feature-7 boxed imagebg" data-overlay="5">
	                    ...
	                    <h4 class="pos-vertical-center">
	                    	<span><?php esc_html_e( 'Next Post', 'stack' ); ?></span>
